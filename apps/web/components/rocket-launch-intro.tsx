...
function RocketSVG({ className }: { className?: string }) {
  return (
    <svg viewBox="80 0 352 420" fill="#ee502c" className={className} aria-hidden="true">
      {/* Left fin */}
...
export function RocketLaunchIntro() {
  ...
  useEffect(() => {
    ...
    tl.to(glow, { opacity: 0.8, scale: 1.3, duration: 0.6, ease: "power2.out" }, 0)
      ...
      .to(glow, { opacity: 0, duration: 0.4, ease: "power1.out" }, 2.0)
      .to(exhaust, { opacity: 0, duration: 0.4, ease: "power1.out" }, 2.0)
      .add(() => {
      ...
      .to(logoFinal, { opacity: 0, duration: 0.5, ease: "power2.inOut" }, 3.3)
      .to(container, { opacity: 0, duration: 0.5, ease: "power2.inOut" }, 3.3);
